...
runs the desktop app and the API side by side from a single invocation. See [macOS GUI](../interfaces/macos-gui.md), [Linux GUI](../interfaces/linux-gui.md), and [Recipes](../usage/recipes.md) for more combinations.
