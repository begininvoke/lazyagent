...
- [Show rate-limit usage](maintenance/limits.md) — on-demand rate-limit / billing summary for Claude Code (5h + 7d), Codex (5h + 7d), Grok (monthly), and Kimi Code, with a detailed pace view via `--detailed`
